                    ...
                    <br>
                     ...
                     <div class="">
                         <div class="">
                             ...
                             <div class="form-group">
                                    <div class="col-md-12"><strong><input disabled type="checkbox" name="<?php echo e($reponse[$i]->libelle); ?>" value="<?php echo e($reponse[$i]->montant); ?>"><?php echo e($reponse[$i]->libelle); ?></strong></div>
                             ...
                             <?php if($testeur): ?>
                             <div class="form-group">
                                    <div class="col-md-12"><strong><input  type="checkbox" name="<?php echo e($reponse[$i]->libelle); ?>" value="<?php echo e($reponse[$i]->montant); ?>"><?php echo e($reponse[$i]->libelle); ?></strong></div>
...
<?php /**PATH C:\laragon\www\StandPlace\resources\views/index/paiement.blade.php ENDPATH**/ ?>