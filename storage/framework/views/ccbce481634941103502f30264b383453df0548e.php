                    ...
                    <table  class="table table-striped m-b-10 centre" style="cursor: pointer;" id="tableetudiants">
                        ...
                        <tbody id="corps">
                            ...
                            <tr id="">
                                ...
                                <td tabindex="1">
                                    <a href="#"  id="voir-etu" data-id="<?php echo e($classe[$i]->code_f.' '.$classe[$i]->code_classe); ?>" data-toggle="modal" data-target="">
...
<?php /**PATH C:\laragon\www\StandPlace\resources\views/administration/layout/corpsEtudiant.blade.php ENDPATH**/ ?>