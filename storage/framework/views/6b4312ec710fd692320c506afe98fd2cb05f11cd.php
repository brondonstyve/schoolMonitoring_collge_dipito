                        ...
                        <ul class="metismenu in" id="side-menu">
                            ...
                            <li class="">
                                ...
                                <ul class="nav-second-level collapse" aria-expanded="false">
                                    ...
                                    <li><a href="<?php echo e(route('index_titulaire_path')); ?>">titulaire de classe</a></li>
                                        <li>
                                                <a href="javascript: void(0);">
                            ...
                            <li>
                                ...
                                <ul class="nav-second-level collapse" aria-expanded="false">
                                    <li><a href="<?php echo e(route('afficher_filiere_path')); ?>">Gérer les séries</a></li>
                            ...
                            <li>
                                ...
                                <ul class="nav-second-level collapse" aria-expanded="false">
                                    <li><a href="<?php echo e(route('etudiants_path')); ?>">Gérer les élèves</a></li>
                                    <li><a href="<?php echo e(route('etudiants_path')); ?>">Transfert d'élèves</a></li>
                                    <li><a href="<?php echo e(route('etudiants_path')); ?>">Liste</a></li>
                                </ul>
                            </li>
                            ...
                            <li id="caisse">
                                ...
                                <ul class="nav-second-level collapse" aria-expanded="false">
                                    ...
                                    <li><a href="<?php echo e(route('moratoire_path')); ?>">Moratoires</a></li>
...
<?php /**PATH C:\laragon\www\StandPlace secondaire_col_dipito\resources\views/administration/layout/entete_menu_bar.blade.php ENDPATH**/ ?>