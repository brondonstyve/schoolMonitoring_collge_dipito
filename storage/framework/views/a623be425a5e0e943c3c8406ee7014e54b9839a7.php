                            ...
                            <div class="woocommerce" >
                                <div class="row" id="customer_login" >
                                    ...
                                    <div class="col-md-sty woocommerce">
                                        ...
                                        <form action="<?php echo e(route('compte_store_path')); ?>" method="post" class="register widget" role="form"  >
                                                <?php echo e(csrf_field()); ?>

                                                <p class="form-group form-row form-row-wide">
                                                        <input class="input-text" type="text" name="nom" id="password" placeholder="Nom" required>
                                                        <?php echo $errors->first('nom','<p class="error">:message</p>'); ?>
