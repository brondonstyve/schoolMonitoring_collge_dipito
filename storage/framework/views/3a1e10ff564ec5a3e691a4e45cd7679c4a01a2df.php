        ...
        <div class="col-sm-12">
            <div class="card-box">
                ...
                <h4 class="m-t-0 header-title" id="title"><b id="b">Aucun Paiement fixé pour <?php echo e($filiere[0]->nom); ?></b></h4>
                  <?php else: ?>
                  <h4 class="m-t-0 header-title" id="title"><b id="b">Liste des paiements des  <?php echo e($reponse[0]->nom); ?>s</b></h4>
                  ...
                  <div class="table-responsive">
                      <table  class="table table-striped m-b-10 centre" style="cursor: pointer;" id="tableetudiants">
                          ...
                          <tbody id="corps">
                              ...
                              <tr id="">
                                  <td tabindex="1"><?php echo e($reponse[$i]->libelle); ?></td>
...
<?php /**PATH C:\laragon\www\StandPlace secondaire\resources\views/administration/layout/corpsTaux.blade.php ENDPATH**/ ?>