                    ...
                    <table  class="table table-striped m-b-10 centre" style="cursor: pointer;" id="tableSolvabilite">
                        ...
                        <tbody id="">
                            ...
                            <tr id="">
                                ...
                                <td tabindex="1">
                                    <a href="<?php echo e(route('liste_penalite_path')); ?>?classe=<?php echo e($classe[$i]->code_f.' '.$classe[$i]->code_classe); ?>&filiere=<?php echo e($classe[$i]->filiere); ?>&niveau=<?php echo e(0); ?>">
...
<?php /**PATH C:\laragon\www\StandPlace secondaire_col_dipito\resources\views/administration/layout/corpsSolvabilite.blade.php ENDPATH**/ ?>