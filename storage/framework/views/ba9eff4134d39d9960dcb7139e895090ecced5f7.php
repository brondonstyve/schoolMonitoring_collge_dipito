...
<h3 class="centre">evaluation de <?php echo e($evaluation[0]->matiere); ?> pour
    <?php switch($evaluation[0]->libelle):
    case (1): ?>
      le CC 1
        <?php break; ?>
    <?php case (2): ?>
                ...
                <table class="table m-0 table-colored-bordered table-bordered-success">
                    ...
                    <tr>
                        <td colspan="4" class="centre">
                            ...
                            <input type="hidden" name="sek" value="<?php echo e(encrypt( $evaluation[0]->libelle)); ?>">
...
<div class="col-md-10">
        <h3 class="centre">résultat de l'évaluation de <?php echo e($matiere); ?> pour :
            <?php switch($libelle):
            case (1): ?>
              le CC 1
                <?php break; ?>
...
<?php /**PATH C:\laragon\www\StandPlace secondaire_col_dipito\resources\views/compte/corpsComposition.blade.php ENDPATH**/ ?>