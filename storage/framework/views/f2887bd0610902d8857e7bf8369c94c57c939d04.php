                ...
                <div class="modal-body">
                          <div class="col-md-12">
                              <div class="form-group">
                                    ...
                                    <input type="text" name="filiere" id="lib" class="form-control" placeholder="Série" required>
                              </div>
...
<?php /**PATH C:\laragon\www\StandPlace secondaire_col_dipito\resources\views/administration/layout/corpsClasse.blade.php ENDPATH**/ ?>