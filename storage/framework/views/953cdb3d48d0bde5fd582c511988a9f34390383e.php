                    ...
                    <form class="form-horizontal form-material" id="loginform" action="index.html">
                        ...
                        <div class="form-group m-b-0">
                            <div class="col-sm-12 text-center">
                                Don't have an account? <a href="https://wrappixel.com/demos/admin-templates/material-pro/horizontal/pages-register.html" class="text-info m-l-5"><b>Sign Up</b></a>
                            </div>
                        </div>
                    </form>
