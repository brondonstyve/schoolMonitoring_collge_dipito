                        ...
                        <div class=" contact-box" style="top: -0px; background-color: #57bec5;max-width: 90%; relative;right: -10%;" >
                            <a href="<?php echo e(route('evaluer_classe_path')); ?>?path_directori=<?php echo e($epreuve[$u]->id); ?>&path_directoric=<?php echo e($epreuve[$u]->matiere); ?>&path_dir=<?php echo e($epreuve[$u]->classe); ?>" title="Cliquer pour créer une évaluation">
                                ...
                                <div class="mail-contnet">
                                    ...
                                    <span class="btn-sm"
                                        style="text-transform: uppercase;color:brown">Séquence <?php echo e($epreuve[$u]->libelle); ?></span>
                            </a>
                                                ...
                                                <div class="modal-title">
                                                    ...
                                                    <form action="<?php echo e(route('Envoyer_epreuve_path')); ?>" method="post" class="centre">
                                                        ...
                                                        <table >
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <select name="path_prof" class="form-control">
                                                                        <?php for($nb =0 ; $nb <sizeOf($prof) ; $nb++): ?>
                                                                        <option value="<?php echo e($prof[$nb]->id.'-'.$prof[$nb]->nom.' '.$prof[$nb]->prenom); ?>">
                                                                                <?php echo e($prof[$nb]->nom.' '.$prof[$nb]->prenom); ?>
                ...
                <div class="message-box contact-box">
                    ...
                    <div class="message-widget contact-widget" style="background-color: antiquewhite"
                        ...
                        <a href="storage\epreuve\<?php echo e($evaluation[$i]->epreuve); ?>">
                            ...
                            <div class="mail-contnet">
                                <h5 style="text-transform: uppercase">évaluation de <?php echo e($evaluation[$i]->nom); ?> en <?php echo e($evaluation[$i]->class_mat); ?> pour la séquence : <?php echo e($evaluation[$i]->libelle); ?></h5>
                            ...
                            <div class="table-responsive">
                                    <form action="<?php echo e(route('generer_epreuve_path')); ?>" method="post">
                                            ...
                                            <div class="form-group">
                                                        ...
                                                        <div class="form-group">
                                                                <div class="col-md-7"><strong>Libellé:</strong></div>

                                                                <select name="libelle" id="" class="form-control" style="min-width: 100%;text-transform: uppercase">
                                                                        <?php
                                                                        $cc=0;
                                                                        $sequence=0;
                                                                        $parcoureur=0;
                                                                        $trimestre=0;
                                                                    ?>
                                                                <?php for($sek = 0; $sek < $sekuence; $sek++): ?>

                                                                            <?php if($parcoureur<2): ?>

                                                                            <option value="<?php echo e($sek+1); ?>">CC <?php echo e(++ $cc); ?></option>
                                                                        ...
                                                                        <option value="<?php echo e($sek+1); ?>">Séquence <?php echo e(++ $sequence); ?></option>
                    ...
                    <tbody>
                        ...
                        <?php for($i = 0; $i < $nbre_k; $i++): ?> <tr class="">
                            ...
                            <tr>
                                ...
                                <th style="text-transform: uppercase;float: right">Séquence</th>
                                <td style="width: 25%">
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\StandPlace secondaire_col_dipito\resources\views/compte/sousCompte/eval_enseignant.blade.php ENDPATH**/ ?>