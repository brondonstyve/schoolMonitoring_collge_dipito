                    ...
                    <div class="dropdown-menu scale-up-left">
                            <ul class="mega-dropdown-menu row">
                                <li class="col-lg-9 col-xlg-3 m-b-30">
                                    <h4 class="m-b-20"><?php echo e($utilisateur->nom); ?></h4>
                                    <!-- CAROUSEL -->
          ...
          <div class="card">
              ...
              <div class="tab-content">
                      ...
                      <div class="card-body">
                          <div class="profiletimeline">
                              ...
                              <div class="sl-item">
                                  ...
                                  <div class="sl-right">
                                      <div> <a href="#" class="link"><?php echo e($utilisateur->nom); ?></a> <span class="sl-date"> en ligne </span>
                              ...
                              <div class="sl-item">
                                  ...
                                  <div class="sl-right">
                                      <div><a href="#" class="link"><?php echo e($utilisateur->nom); ?></a> <span class="sl-date">il y'a 5 min</span>
                      ...
                      <div class="card-body">
                          <div class="row">
                              <div class="col-md-3 col-xs-6 b-r"> <strong>Nom</strong>
                                  <p class="text-muted"><?php echo e($utilisateur->nom); ?></p>
                              </div>
                  ...
                  <div class="tab-pane" id="settings" role="tabpanel">
                      <div class="card-body">
                          <form action=" <?php echo e(route('compte_editP_path')); ?> " method="POST" class="form-horizontal form-material">
                            ...
                            <div class="form-group">
                                  ...
                                  <div class="col-md-12">
                                      <input type="text" value="<?php echo e($utilisateur->nom); ?>" name="nom" class="form-control form-control-line">
                                      <?php echo $errors->first('nom','<p style="color:red;">:message</p>'); ?>
                              ...
                              <div class="form-group">
                                  ...
                                  <div class="col-md-12">
                                      <input type="email"value="<?php echo e($utilisateur->email); ?>" class="form-control form-control-line" name="email" id="example-email">
                                      <?php echo e($errors->first('email','<p style="color:red;">:message</p>')); ?>
                              ...
                              <div class="form-group">
                                  ...
                                  <div class="col-md-12">
                                      ...
                                      <?php echo e($errors->first('mdp','<p style="color:red;">:message</p>')); ?>
                              ...
                              <div class="form-group">
                                  ...
                                  <div class="col-md-12">
                                      <input type="text"value="<?php echo e($utilisateur->téléphone); ?>" class="form-control form-control-line" name="numero">
                                  </div>
                              </div>
                              </div>
                              <div class="form-group">
