            ...
            <div class="modal-body">
                <form action="<?php echo e(route('paiement_path')); ?>" method="post" class="form-horizontal form-material "
                    ...
                    <div class="form-group">
                        ...
                        <div>
                            <input class="form-control" id="nbre_etudiant_classe" placeholder="nombre étudiant" disabled>
                            </select>
                        </div>
                    </div>
...
<?php /**PATH C:\laragon\www\StandPlace primaire\resources\views/administration/layout/paiement.blade.php ENDPATH**/ ?>