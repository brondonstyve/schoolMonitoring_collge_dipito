        ...
        <div class="topbar">
            ...
            <div class="topbar-left">
                <a href="{{ route('accueil_index_path') }}" class="logo">
                    <span>
                                    <img src="images/admin/logo.png" alt="" height="100" >
                                </span>
                    <i>
                            <img src="images/admin/logo.png" alt="" height="458">
                        </i>
                </a>
            </div>
            @php
                    ...
                    <li class="list-inline-item dropdown notification-list">
                        ...
                        <div class="dropdown-menu dropdown-menu-right dropdown-arrow dropdown-lg" aria-labelledby="Preview">
                            ...
                            <div class="dropdown-item noti-title">
                                <h5><span class="badge badge-danger float-right">{{ $compteur }}</span>Notifications</h5>
                            </div>
                            ...
                            <a href="javascript:void(0);" class="dropdown-item notify-item">
                                ...
                                <p class="notify-details" style="color: blue; font-size: 15px">{{ $notificate[$i]->type }}</p>
                                <p class="notify-details">{{ $notificate[$i]->message }}
                        ...
                        <ul class="metismenu in" id="side-menu">
                            ...
                            <li class="">
                                ...
                                <ul class="nav-second-level collapse" aria-expanded="false">
                                    <li><a href="{{ route('stat_etudiant_path') }}">étudiants</a></li>
                            ...
                            <li class="">
                                ...
                                <ul class="nav-second-level collapse" aria-expanded="false">
                                    ...
                                    <li><a href="{{ route('index_titulaire_path') }}">titulaire de classe</a></li>
                                        <li>
                                                <a href="javascript: void(0);">
                                                    <img src="images/admin/privileges.png" class="fi-briefcase" style="max-width: 10%">
                                                    <span> Gérer les comptes </span><b class="caret"></b>
                                                </a>
                                                <ul class="nav-second-level collapse" aria-expanded="false">
                            ...
                            <li>
                                <a href="javascript: void(0);">
                                    ...
                                    <span> CLASSES </span> <span class="menu-arrow"><b class="caret"></b></span>
                                </a>
                                <ul class="nav-second-level collapse" aria-expanded="false">
                                    <li><a href="{{ route('afficher_filiere_path') }}">Gérer les séries</a></li>
                            ...
                            <li>
                                <a href="javascript: void(0);">
                                    ...
                                    <span> ELEVES </span> <span class="menu-arrow"><b class="caret"></b></span>
                                </a>
                                <ul class="nav-second-level collapse" aria-expanded="false">
                            ...
                            <li id="caisse">
                                <a href="javascript: void(0);">
                                    ...
                                    <span> COMPTABILITE </span> <span class="menu-arrow"><b class="caret"></b></span>
                                </a>
                                <ul class="nav-second-level collapse" aria-expanded="false">
                                    ...
                                    <li>
                                        ...
                                        <ul class="nav-second-level collapse" aria-expanded="false">
                                                <li><a href="com/adminox/default/chart-echart.html" data-toggle="modal" data-target="#paiement-ancien">Ancien élève</a></li>
                                                <li><a href="com/adminox/default/chart-echart.html" data-toggle="modal" data-target="#paiement-nouveau" id="new-etudiant">Nouvel élève</a></li>
                                        </ul>
                                    </li>
                                    <li><a href="{{ route('solvabilite_path') }}">Solvabilité</a></li>
                                    <li><a href="{{ route('moratoire_path') }}">Moratoires</a></li>
                            ...
                            <li>
                                ...
                                <ul class="nav-second-level collapse" aria-expanded="false">
                                    <li><a href="{{ route('emploi_admin_path') }}">EDT de classe</a></li>
                                    <li><a href="{{ route('emploi_admin_path') }}">EDT évaluations</a></li>
                                </ul>
                            </li>
                            ...
                            <li>
                                ...
                                <ul class="nav-second-level collapse" aria-expanded="false">
                                    <li><a href="{{ route('progrommer_eval_admin_path') }}">Gérer</a></li>
                                </ul>
                            </li>
                            ...
                            <li id="mat">
                                    <a href="javascript: void(0);">
                                        <img src="images/admin/evaluation.png" class="fi-briefcase" style="max-width: 10%">
                                        <span> MATIERES </span> <span class="menu-arrow"><b class="caret"></b></span>
                                    </a>
                                    <ul class="nav-second-level collapse" aria-expanded="false">
                            ...
                            <li>
                                <a href="javascript: void(0);">
                                    ...
                                    <span> VOTES </span> <span class="menu-arrow"><b class="caret"></b></span>
                                </a>
                                <ul class="nav-second-level collapse" aria-expanded="false">
                                    <li><a href="#" data-toggle="modal" data-target="#vote">Lancer un vote</a></li>
                                    <li><a href="{{ route('suspendre_vote_path') }}">Fin du vote</a></li>
                                </ul>
                            </li>
                            ...
                            <li>
                                <a href="javascript: void(0);">
                                    ...
                                    <span> PARAMETRES </span> <span class="menu-arrow"><b class="caret"></b></span>
                                </a>
                                <ul class="nav-second-level collapse" aria-expanded="false">
                                    ...
                                    <li><a href="{{ route('formations_path') }}">Formations</a></li>
                                    <li>
                                            <a href="javascript: void(0);">
                                   ...
                                   <!-- contenu <li><a href="c.html" data-toggle="modal" data-target="#fixer-les-EDT" id="new-taux" >modifier la conf..</a></li>
                                    ...
                                    <li><a href="#" data-toggle="modal" data-target="#sekence">Séquence</a></li>
                            ...
                            <li>
                                <a href="javascript: void(0);">
                                    <img src="images/admin/annee.png" class="fi-briefcase" style="max-width: 10%">
                                    <span>ANNEE SCOLAIRE</span> <span class="menu-arrow"><b class="caret"></b></span>
                                </a>
                                <ul class="nav-second-level collapse" aria-expanded="false">
                            ...
                            <li>
                                <a href="javascript: void(0);">
                                    <img src="images/admin/edt.png" class="fi-briefcase" style="max-width: 10%">
                                    <span> EVENEMENTS </span> <span class="menu-arrow"><b class="caret"></b></span>
                                </a>
                                <ul class="nav-second-level collapse" aria-expanded="false">
                                    <li><a href="{{ route('evenement_path') }}">Gérer les évènements</a></li>
