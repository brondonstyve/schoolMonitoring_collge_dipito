...
<div id="voir-les-taux" class="modal fade" role="dialog">
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('voir_taux_path') }}" method="post" class="form-horizontal form-material "
                        id="formulaire-mtaux">
                        {{ csrf_field() }}
                        <div class="form-group ">
                            <div class="">
...
<div id="adresse" class="modal fade" role="dialog">
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{ route('adresses_path') }}" method="post" class="form-horizontal form-material ">
                    {{ csrf_field() }}
                        <div class="form-group">
                            <div class="col-md-12"><strong>Adresse email:</strong></div>
                            <input type="text" name="email" class="form-control" value="{{ $r=(sizeOf($adresse) > 0)? $adresse[0]->email : 'non défini' }}" />
                        </div>
                        <div class="form-group">
                            <div class="col-md-12"><strong>Adresse email admin:</strong></div>
                            <input type="email" name="emailAdmin" class="form-control" value="{{ $r=(sizeOf($adresse) > 0)? $adresse[0]->emailAdmin : 'non défini' }}"/>
                        </div>

                        <div class="form-group">
                            <div class="col-md-12"><strong>Numéro de téléphone:</strong></div>
                            <input type="number" name="numero"  max="99999999999" class="form-control" value="{{ $r=(sizeOf($adresse) > 0)? $adresse[0]->numero : 'non défini' }}"/>
                        </div>

                        <div class="form-group">
                            <div class="col-md-12"><strong>Adresse l'établissement (rue,ville,quartier):</strong></div>
                            <input type="text" name="adresse" class="form-control" value="{{ $r=(sizeOf($adresse) > 0)? $adresse[0]->adresse : 'non défini' }}"/>
                        </div>

                        <div class="form-group">
                            <div class="col-md-12"><strong>Adresse facebook:</strong></div>
                            <input type="url" name="facebook" class="form-control" value="{{ $r=(sizeOf($adresse) > 0)? $adresse[0]->facebook : 'non défini' }}"/>
                        </div>

                        <div class="form-group">
                            <div class="col-md-12"><strong>Adresse instagram:</strong></div>
                            <input type="url" name="instagram" class="form-control" value="{{ $r=(sizeOf($adresse) > 0)? $adresse[0]->instagram : 'non défini' }}"/>
                        </div>

                        <div class="form-group">
                            <div class="col-md-12"><strong>Adresse Google +:</strong></div>
                            <input type="url" name="google" class="form-control" value="{{ $r=(sizeOf($adresse) > 0)? $adresse[0]->google : 'non défini' }}"/>
                        </div>

                        <div class="form-group">
                            <div class="col-md-12"><strong>Adresse twitter:</strong></div>
                            <input type="url" name="twitter" class="form-control" value="{{ $r=(sizeOf($adresse) > 0)? $adresse[0]->twiter : 'non défini' }}"/>
                        </div>
...
<div id="apropos" class="modal fade" role="dialog">
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{ route('a_propos_path') }}" method="post" class="form-horizontal form-material ">
                    {{ csrf_field() }}
                        <div class="form-group">
                            <div class="col-md-12"><strong>A propos:</strong></div>
                            <textarea name="apropos" id="" cols="30" rows="20" minlength="500" class="form-control" value="{{ $r=(sizeOf($adresse) > 0)? $adresse[0]->emailAdmin : 'non défini' }}" required></textarea>
                        </div>
                        <div class="form-group">
                            <div class="col-md-12"><strong>Mission:</strong></div>
                            <textarea name="mission" id="" cols="30" rows="20" minlength="500" class="form-control" value="{{ $r=(sizeOf($adresse) > 0)? $adresse[0]->emailAdmin : 'non défini' }}" required></textarea>
                        </div>
            </div>
            <div class="modal-footer">
                <input type="submit" value="Envoyer" class="left btn btn-success">
...
<div id="fixer-les-EDT" class="modal fade" role="dialog">
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{ route('configurer_edt_path') }}" method="post" class="form-horizontal form-material "
                    ...
                    <div class="form-group ">
                        <div class="">
                            ...
                            <select name="nbtranche" class="form-control" id="liste-tranche" required>
                                @for ($i =0 ; $i <10 ; $i++)
                                <option @if ($i==0) active @endif value="{{ $i }}">{{ $i }}</option>
                                @endfor
                            </select>
                        </div>
                    </div>
...
<div id="Groupe_matiere" class="modal fade" role="dialog">
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{ route('groupe_mat_path') }}" method="post" class="form-horizontal form-material "
                    id="formulaire-taux">
                    {{ csrf_field() }}
                    <div class="form-group ">
                        <div class="">
...
<div id="sekence" class="modal fade" role="dialog">
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{ route('configurer_séquence_path') }}" method="post" class="form-horizontal form-material "
                    id="formulaire-tranche">
                    @csrf
                    <div class="form-group ">
                        <div class="">
