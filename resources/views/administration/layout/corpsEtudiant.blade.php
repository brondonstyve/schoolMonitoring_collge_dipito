                    ...
                    <table  class="table table-striped m-b-10 centre" style="cursor: pointer;" id="tableetudiants">
                        ...
                        <tbody id="corps">
                            ...
                            <tr id="">
                                ...
                                <td tabindex="1">
                                    <a href="#"  id="voir-etu" data-id="{{ $classe[$i]->code_f.' '.$classe[$i]->code_classe }}" data-id_classe="{{ $classe[$i]->id }}" data-toggle="modal" data-target="">
                            ...
                            <tr>
                                <td colspan="7">
                                    <a href="{{ route('liste_tout_etudiant_path') }}">
