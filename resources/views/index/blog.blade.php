    ...
    <div class="commentform row reset-button-default">
            <div class="col-sm-8">
                    <div id="respond" class="comment-respond">
                        <form action="{{ route('ajouterBlog_path') }}" method="post" id="commentform" class="comment-form">
                            {{ csrf_field() }}
                            <br>
                ...
                <div id="primary" class="content-area">
                    <div id="content" class="site-content detail-post" role="main">
                        ...
                        <div id="comments" class="comments-area">
                            ...
                            <h3 class=" dropdown-user btn-sm"> @if (sizeOf($commentaire)>1) {{ sizeOf($commentaire) }} commentaires @else {{ sizeOf($commentaire) }} commentaire @endif</h3>
                                            ...
                                            <div class="comment-box media-body">
                                                <div class="comment-author clearfix">
                                                    @if ($utilisateur->type=='superadmin')
                                                       <strong>{{ $commentaire[$i]->nom.' de la '.$commentaire[$i]->classe }}</strong>
                                                        @else
                                                        <strong>Utilisateur</strong>
                                                    @endif

                                                    <span class="date-comment">  à {{ $commentaire[$i]->created_at }}</span>

                                                </div>
                                                <div class="comment-text">
                                                    <p>{{ $commentaire[$i]->message }}</p>
                                                </div>
                                            </div>
                                        </div>
                                    </li>
                                ...
                                <div class="col-sm-12">
                                    <div id="respond" class="comment-respond">
                                        <form action="{{ route('reponse_Blog_path') }}" method="post" id="commentform" class="comment-form">
                                            ...
                                            <p class="form-submit">
                                                <input type="hidden" name="blog" value="{{ $reponse[0]->id }}">
