                                                ...
                                                <div class="form-group" style="text-align: center;">
                                                    <div class="col-md-12 m-b-20 carousel-inner">
                                                        <div class="fileupload bouton btn-danger btn-rounded waves-effect carousel-inner">
                                                            <span>
                                                                    <a href="{{ route('supprimer_tout_cours_path') }}">Confirmer</a>
                                                            </span>
                                                        </div>
                                                    </div>
                                                </div>
        ...
        <div class="message-widget contact-widget" style="background-color: white" title="">
                ...
                <a data-toggle="collapse" data-target="#demo{{ $i }}">
                    ...
                    <div class="mail-contnet">
                        <h5 style="text-transform: uppercase"> {{ $cour[$i]->classe }} </h5>
                        <span class="mail-desc"> Cliquer pour dérouler et voir les cours de la {{ $cour[$i]->classe }} </span>
                    </div>

                </a>
                <h6 class="">
                  <h6 data-toggle="modal" data-target="#cours" id="new_course" data-classe="{{ $cour[$i]->classe }}">
                    Ajouter un cours à la {{ $cour[$i]->classe }} ici  <img src="images/icones/add-green.png" class="btn btn-circle btn-lg waves-effect">
                  </h6>
                </h6>
                <!-- sous menu -->
             ...
             <!--fin suppression-->
                    ...
                    @if ($course[$c]->classe==$cour[$i]->classe)

                    <div class="collapse contact-box" id="demo{{ $i }}" style="top: -0px; background-color: #57bec5;max-width: 90%; relative;right: -10%;">
                        <a href="{{ route('coursDetail_path') }}?cour={{ encrypt($course[$c]->id_cours) }}&&mat={{ encrypt($course[$c]->matiere) }}" title="Cliquer pour voir" id="{{ $course[$c]->id_cours }}">
                            <div class="user-img"> <img src="images/courrs.png" alt="user" class="img-circle">
                                <span class="profile-status online pull-right" style="color: black"></span>
                            </div>

                            <div class="mail-contnet">
                                    <h5 style="text-transform: uppercase">cours de {{ $course[$c]->nom }} </h5>
                                    <span class="mail-desc">libellé: {{ $course[$c]->libelle }}</span>
                                ...
                                <span class="btn-sm" style="text-transform: uppercase;color:brown">
                                    <span class="mail-desc" style="display: inline-block; max-width: 20px; right: 50%">
                                        <img src="images/icones/del-red.png" alt="" title="supprimer" data-toggle="modal" data-target="#add-sup0" data-id="{{ $course[$c]->id_cours }}" id="img_supp">
                                    </span>
                                </span>
                        </a>
                    </div>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form action=" {{ route('enregistrer_cours_path') }} " method="POST" enctype="multipart/form-data">
            @csrf
