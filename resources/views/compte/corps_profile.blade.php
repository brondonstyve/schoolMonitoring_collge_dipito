                            ...
                            <div class="tribe-events-image">
                                ...
                                <div class="tribe-events-title-wrapper">
                                    <h2 class="tribe-events-list-event-title">
                                        <a class="tribe-event-url" href="" title="Remise des diplomes">{{ $evenement[0]->titre }} </a>
                                    </h2>
                                </div>
                            </div>
                            <div class="tribe-events-inner">
                                ...
                                <div class="entry-meta-wrapper">
                                    ...
                                    <div class="tribe-event-cost">
                                        <span><i class="mn-icon-961"></i>{{ $date->format('d  M Y') }}</span>
                                    </div>
                                    <div class="info-time">
                                        <i class="mn-icon-1111"></i>{{ $evenement[0]->debut }} <span class="space">A</span> {{ $evenement[0]->fin }} </div>

                                    <div class="tribe-events-venue-details">
                                        <i class="mn-icon-1142"></i> {{ $evenement[0]->description }} </div>
                                </div>
                            </div>
                        </div>
                    </div>
                      ...
                      <div id="post-289" class="type-tribe_events post-289 tribe-clearfix tribe-events-category-distance-learning tribe-events-category-english-for-university tribe-events-venue-303 tribe-events-organizer-306 tribe-events-first">
                          <div class="tribe-events-list event-grid">
                              ...
                              <div class="tribe-events-image">
                                  ...
                                  <div class="tribe-events-title-wrapper">
                                      <h2 class="tribe-events-list-event-title">
                                          <a class="tribe-event-url" href="" title="Remise des diplomes">{{ $evenement[$i]->titre }} </a>
                                      </h2>
                                  </div>
                              </div>
                              <div class="tribe-events-inner">
                                  ...
                                  <div class="entry-meta-wrapper">
                                      ...
                                      <div class="info-time">
                                          <i class="mn-icon-1111"></i>{{ $evenement[$i]->debut }} <span class="space">A</span> {{ $evenement[$i]->fin }} </div>

                                      <div class="tribe-events-venue-details">
                                          <i class="mn-icon-1142"></i> {{ $evenement[$i]->description }} </div>
                                  </div>
                              </div>
                          </div>
                      </div>
                    ...
                    <div id="post-289" class="type-tribe_events post-289 tribe-clearfix tribe-events-category-distance-learning tribe-events-category-english-for-university tribe-events-venue-303 tribe-events-organizer-306 tribe-events-first">
                        <div class="tribe-events-list event-grid">
                            ...
                            <div class="tribe-events-image">
                                ...
                                <div class="tribe-events-title-wrapper">
                                    <h2 class="tribe-events-list-event-title">
                                        <a class="tribe-event-url" href="" title="Remise des diplomes">{{ $evenement[$t]->titre }} </a>
                                    </h2>
                                </div>
                            </div>
                            <div class="tribe-events-inner">
                                ...
                                <div class="entry-meta-wrapper">
                                    ...
                                    <div class="info-time">
                                        <i class="mn-icon-1111"></i>{{ $evenement[$t]->debut }} <span class="space">A</span> {{ $evenement[$t]->fin }} </div>

                                    <div class="tribe-events-venue-details">
                                        <i class="mn-icon-1142"></i> {{ $evenement[$t]->description }} </div>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="card color-md card-size">
            <div class="card-body">
                ...
                <div class="col-12" style="background-color: aliceblue">
                    ...
                    @endphp
                    <span class="day">{{ $date->format('d') }}</span>
                    <span class="month-year">{{ $date->format('M Y') }}</span> de
                    <i class="mn-icon-1111"></i>{{ $evenement[$i]->debut }} <span class="space">A</span> {{ $evenement[$i]->fin }}
              </div>
              <br>
                @endif
    ...
    <div class="col-lg-4 col-xlg-3 col-md-5">
        <div class="card blog-widget card-size1 color-md1">
            ...
            @else
                    ...
                    <h3>{{ $blog[0]->titre }}</h3>
                    <label class="label label-rounded label-success">{{ $blog[0]->titre }}</label>
                    <p class="m-t-20 m-b-20">
                            {{ $blog[0]->description }}
                    </p>
                    <div class="d-flex">
                        <div class="read"><a href="" class="link font-medium"><a href="{{ route('blog_detail_path') }}?di={{ $blog[0]->id }}">Lire plus</a> </a></div>
                    ...
                    <div class="message-widget contact-widget">
                        ...
                        <a href="#">
                            ...
                            <div class="mail-contnet">
                                <h5>Brondon</h5> <span class="mail-desc">{{ $utilisateur->téléphone }}</span>
                            </div>
                        </a>
