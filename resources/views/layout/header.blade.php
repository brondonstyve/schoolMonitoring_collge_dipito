        ...
        <div class="left-topbar clearfix pull-left">
            <aside id="apus_socials_widget-2" class="widget widget_apus_socials_widget">
                <ul class="social list-unstyled list-inline bo-sicolor">
                    <li>
                        <a href="
                        {{ $r=(sizeOf($adresse)>0)? 'http://'.$adresse[0]->facebook :'http://facebook.com' }}
                        ">
                    ...
                    <li>
                        <a href="
                        {{ $r=(sizeOf($adresse)>0)? 'http://'.$adresse[0]->instagram :'http://instagram.com' }}
                        ">
                    ...
                    <li>
                        <a href="
                        {{ $r=(sizeOf($adresse)>0)? 'http://'.$adresse[0]->google :'http://google+.com' }}
                        ">
                    ...
                    <li>
                        <a href="
                        {{ $r=(sizeOf($adresse)>0)? 'http://'.$adresse[0]->twiter :'http://twitter.com' }}
                        ">
            ...
            <aside id="text-2" class="widget widget_text">
                <div class="textwidget">
                    <div class="contact-topbar btn-sm">
                        <span>{{ $r=(sizeOf($adresse)>0)? $adresse[0]->email :'contact@schoolmonitoring.com' }}</span>
                        <span>Tél. {{ $r=(sizeOf($adresse)>0)? $adresse[0]->numero :'(237) 6 97 32 09 74' }}</span>
                    </div>
                </div>
            </aside>
        </div>
