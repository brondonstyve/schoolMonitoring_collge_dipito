<section id="main-container" class="container-fluid inner" >
    ...
    <div class="content">
            {{ $r=(sizeOf($adresse)>0)? $adresse[0]->email :'contact@schoolmonitoring.com' }}
    </div>
    </div>
    </div>
    ...
    <div class="content">
       {{ $r=(sizeOf($adresse)>0)? $adresse[0]->numero :'(237) 6 97 32 09 74 / 690 322 179' }}
    </div>
    </div>
    </div>
    ...
    <div class="content">
            {{ $r=(sizeOf($adresse)>0)? $adresse[0]->adresse :'Non définie' }}
    </div>
    </div>
    </div>
    </div>
